...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter a valid material ID" ControlToValidate="tb_MatID"></asp:RequiredFieldValidator>
    <br />
    <br />
